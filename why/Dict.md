...
| 용어 | 정의 |
| --- | :--- |
|TDD  | 테스트 주도 개발(Test-driven development, TDD)의 줄임말이다. 소프트웨어 개발 방법론 중 하나이며 애자일 방식과 비교해보면 좋을 것 같다.|
|Agile | [Agile : 기민한, 좋은 것을 빠르고 낭비없게 만드는 것]의 뜻을 가지고 있다. 소프트웨어 개발 방법론 중 하나이며 TDD와 폭포수 개발 이론과 비교해보면 좋을 것 같다.|
